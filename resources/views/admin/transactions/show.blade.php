    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @if ($subscribeTransaction->is_paid)
                    <div class="flex flex-row gap-x-2 items-center center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-check-circle text-green-500">
                            <path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"></path>
                            <polyline points="9 11 12 14 22 4"></polyline>
                        </svg>
                        <span class="text-green-500 font-bold">Transaction has been approved</span>
                    </div>
                @else
                    <hr class="my-5">
